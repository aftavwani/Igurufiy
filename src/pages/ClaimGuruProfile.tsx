...
const ClaimGuruProfile: React.FC = () => {
  ...
  const [captureImgError, setCaptureImgError] = useState<any>(null);
  const [imageDataError, setImageDataError] = useState<any>(null);
  ...
  const submitBtn = (data: any) => {
    ...
    if (imageData === null) {
      setImageDataError("Upload Image is a required field");
      return false;
    }

    if (imageCapture === null) {
      setCaptureImgError("Upload Image is a required field");
      return false;
    }

    const formData = new FormData();
    formData.append("username", data.username);
    formData.append("profile_link", data.link);
    formData.append("full_name", data.fullName);
    formData.append("dob", data.dob);
    formData.append("email", data.email);
    formData.append("images1", imageData);
    formData.append("images2", imageCapture);
    ...
    if (subscriptionData == false) {
      ...
      if (checkboxData == true && subscriptionData == true) {
        setstartLoading(true);
        const Url = process.env.API_SOME_KEY + "save-guru-profile/";
    ...
    <>
      ...
      <IonPage id="main-content" className="bg-color">
        ...
        <IonContent fullscreen className="top-section">
          ...
          <div className="inner-content registration claim-form">
            <form
            ...
            >
              <IonLabel color="light">
                Your Instagram or TikTok Username
              </IonLabel>
              <IonInput
                {...register("username", {
              ...
              <IonLabel color="light">
                Link of the Igurufy Profile to be Claimed
              </IonLabel>
              <IonInput
                {...register("link", {
              ...
              <div className="claim-upload-file">
                <label htmlFor="file-upload-id" className="custom-file-upload">
                  {imageData != null ? imageData?.name : "No choosen file"}
                </label>
                <input
                  {...register("images1")}
                  id="file-upload-id"
              ...
              <div className="error">{imageDataError}</div>

              <IonLabel className="label upload-label" color="light">
                Capture and Upload a selfie holding your TikTok username on a
                paper
              </IonLabel>
              <div className="claim-upload-file">
                <label
              ...
              <div className="error">{captureImgError}</div>
      ...
      <IonModal
        ...
        ref={modalTerms}
        trigger={checkboxData === false ? "open-claimGrur-terms" : ""}
      >
        ...
        <IonContent>
          ...
          <IonList>
            ...
            <IonItem className="list-item">
              ...
              <p>Access to FLAGE your review for re-evalution</p>
            </IonItem>
            <IonItem className="list-item">
              <IonAvatar slot="start">
                <IonIcon
              ...
              <p>48 Hour Costomer Service Responce Time from IGURUFY Team</p>
            </IonItem>
            <IonItem className="list-item">
              <IonAvatar slot="start">
                <IonIcon
...
export default ClaimGuruProfile;
