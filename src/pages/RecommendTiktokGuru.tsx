...
const RecommendTiktokGuru: React.FC = () => {
  const {
    handleSubmit,
    register,
    reset,
      ...
      <IonPage id="main-content" className="bg-color">
        ...
        <IonContent fullscreen className="top-section">
          ...
          <div className="gurus-content">
            <p className="heading">Recomend TikTok Guru To Be Added</p>
            <div className="recomend-tabs">
              ...
              <Link className="active link" to="/recomend-tiktok-guru">
                <div className="link">
                  {" "}
                  Recommend <br />
                  TikTok Guru <br />
            ...
            <form onSubmit={handleSubmit(onSubmitTiktok)}>
...
export default RecommendTiktokGuru;
