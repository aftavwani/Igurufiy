...
const TikTokRegistration: React.FC = () => {
  ...
  const [tiktok_usernameErrorMsg, settiktok_usernameErrorMsg] = useState("");
  ...
  const submitBtn = (data: any) => {
    ...
    if (checkNetwok === true) {
      ...
      // PushNotifications.addListener("registration", (token: Token) => {
        ...
        formData.append(
          "tiktok_username",
          validator.trim(data.tiktok_username)
        );
        ...
        formData.append("tiktok_username_photo", livePhoto);
        ...
        if (subscriptionData == false) {
          ...
          if (checkboxData == true && subscriptionData == true) {
            ...
            const Url = process.env.API_SOME_KEY + "register-tiktoker/";
  ...
  const goBack = () => {
    ...
    if (tiktok_usernameErrorMsg.length != 0) {
      settiktok_usernameErrorMsg("");
    }
  ...
  return (
    <>
        ...
        <IonContent fullscreen className="main">
          ...
          <div className="content registration">
            <IonText className="ion-text-center">
              <h4 className="adasdsf">Tiktok Guru Registration</h4>
              <div className="success-error">{errorMsg}</div>
            </IonText>
            ...
            >
              <IonLabel color="light">TikTok Username</IonLabel>
              <IonInput
              ...
              />
              <div className="already-used">{tiktok_usernameErrorMsg}</div>
              ...
              <IonLabel className="label upload-label" color="light">
                Capture or Upload a selfie holding your TikTok username on a
                paper
              </IonLabel>
              <div className="upload-file">
                <div className={"sign-upload-file social-media-img " + iosDeviceClass}>
                  ...
                  <label
                    htmlFor="file-upload-tiktok-selfie"
                    // className="custom-file-upload"
                  >
              ...
              <div className="ion-color-light checked1">
                ...
                <IonCheckbox
                  ...
                  checked={ifChecked}
                  id="open-tiktok-modal"
                  name="checkk"
                >
                  <p style={{ fontSize: "12px" }}>Premium Subscription</p>
                </IonCheckbox>
      ...
      <IonModal
        ...
        ref={modalTerms}
        trigger={checkboxData === false ? "open-tiktok-terms" : ""}
      >
...
export default TikTokRegistration;
