...
const RecommendInstagramGuru: React.FC = () => {
  const {
    handleSubmit,
    register,
    reset,
      ...
      <IonPage id="main-content" className="bg-color">
        ...
        <IonContent fullscreen className="top-section">
          ...
          <div className="gurus-content">
            <p className="heading">Recomend Instagram Guru To Be Added</p>
            <div className="recomend-tabs">
              <Link className="active link" to="/recomend-instagram-guru">
              ...
              <Link
                onClick={bothGuruClick}
                className="link"
                to="/recomend-both-guru"
              >
                <div className="link ">
            ...
            <form onSubmit={handleSubmit(onSubmitInsta)}>
              ...
              <IonInput
                {...register("guruName", {
                  required: "Guru User Name is a required",
                })}
                placeholder="Instagram Guru Username"
                className="custom"
                name="guruName"
              />
              <ErrorMessage
...
export default RecommendInstagramGuru;
