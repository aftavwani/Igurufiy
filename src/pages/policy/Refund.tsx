      ...
      <IonPage id="main-content" className="bg-color">
        ...
        <IonContent fullscreen className="top-section">
          ...
          <div className="policy-content">
            ...
            <IonText>
              <p>
                <strong>Strick No-Refund Stance </strong>: Subscription
                payments, once completed, cannot be refunted.
              </p>
            </IonText>
            ...
            <IonText>
              <p>
                {" "}
                <strong>Cancellation</strong>: To avoid billing, users must
                cancel their subscriptions 30 days in advance.
              </p>
            </IonText>
