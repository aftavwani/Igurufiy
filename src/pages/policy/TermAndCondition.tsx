      ...
      <IonPage id="main-content" className="bg-color">
        ...
        <IonContent fullscreen className="top-section">
          ...
          <div className="policy-content">
            ...
            <IonText>
              <p>This Agreement was last revised on August 10 2023.</p>
            </IonText>
            ...
            <div>
              ...
              <IonText>
                <p>
                  {" "}
                  We provide you with access to our services through our
                  “Website” (defined below) subject to the following Terms of
              ...
              <IonText>
                <p>
                  ...
                  read, understood, and agree to be lawfully bound by these
              ...
              <IonText>
                <p>
                  In case you do not agree with any of these terms, then kindly
                  do use the Website.
                </p>
              </IonText>
              ...
              <IonText>
                <p>
                  {" "}
                  “Privacy Policy” means “https://igurufy.com/privacy is shown
                  on our website;
                </p>
              </IonText>
              ...
              <IonText>
                <p>
                  “User”, “You” “Reviewer” and “your” are refers to the person
                  who is accessing for taking any service from us. User shall
                  include their @instagram username and email.
                </p>
              </IonText>
              ...
              <IonText>
                <p>
                  ...
                  responding back to “reviewers” regarding their
                  feedback/ratings.
                </p>
              </IonText>
              <IonText>
                <p>
                  {" "}
                  “We”, “us”, “our” and “Company” are references to IGURUFY
                  office at Los Angeles, California United States;
                </p>
              </IonText>
              ...
              <IonText>
                <p>
                  “Applicable Law” means in respect of a person, any statute,
                  law, regulation, ordinance, rule, judgment, decree, by-law,
                  approval from the concerned authority, government resolution,
                  order, directive, guideline, policy, requirement, or other
                  governmental restriction or any similar form of decision, or
                  determination, or any interpretation or adjudication having
                  the force of law of any of the foregoing, by any concerned
                  authority or other requirements of any governmental or
                  regulatory authority, to which such person is subject;
                </p>
              </IonText>
              ...
              <IonText>
                <p>
                  ...
                  opened by the Seller or Guru with the Platform to offer
              ...
              <IonText>
                <p>
                  ...
                  participation in the Membership Plan, paid directly by
              ...
              <IonText>
                <p>
                  {" "}
                  “Membership Plan” shall means the plan available on the
                  Website through which members can avail various services
              ...
              <IonText>
                <p>
                  {" "}
                  Gurus/Influencers: Registered individuals who maintain a
                  profile on IGurufy.com and are subjected to reviews.
                </p>
              </IonText>
              ...
              <IonText>
                <p>
                  2.1. Subscription for Gurus/Influencers: A monthly
              ...
              <IonText>
                <p>
                  {" "}
                  2.2. Non-refundable Fee: Subscription charges, once billed,
              ...
              <IonText>
                <p>
                  {" "}
                  2.3. Automatic Renewal: Subscriptions are renewed and billed
                  on a monthly cycle.
                </p>
              </IonText>
              ...
              <IonText>
                <p>
                  {" "}
                  3.1. User Accountability: All users, both Gurus/Influencers
                  and Reviewers, bear sole responsibility for their content.{" "}
                </p>
              </IonText>
              ...
              <IonText>
                <p>
                  {" "}
                  5.1. Authenticity: Reviews should stem from actual
                  experiences.{" "}
                </p>
              </IonText>
              ...
              <IonText>
                <p>
                  {" "}
                  5.2. Content Standards: Malicious, defamatory, or false
              ...
              <IonText>
                <p>
                  All references to singular include plural and vice versa and
                  the word “includes” should be construed as “without
                  limitation”.
                </p>
              </IonText>
              ...
              <IonText>
                <p>
                  {" "}
                  By using the Website or Services in any manner, you are bound
                  by these Terms of Service, as well as the terms of the
                  Agreement identified above. In case you do not accept the
                  terms, then kindly do not use the Website. If you are agreeing
                  with these Terms on behalf of a Company, organization,
                  government, or other legal entity, you hereby represent and
                  warrant that (a) you are legally authorized to do so, (b) the
                  entity agrees to be legally bound by the Terms, and (c)
                  neither you nor the entity is barred from using the Services
                  or accepting the Terms under the laws of the applicable
                  jurisdiction.
                </p>
              </IonText>
              ...
              <IonText>
                <p>
                  ...
                  apply to Third-Party Products or Services, which are governed
              ...
              <IonText>
                <p>
                  {" "}
                  Eligibility: Certain Service of the Website is not available
                  to minors under the age of 13 or to any users suspended or
              ...
              <IonText>
                <p>
                  ...
                  e-mails and other electronic communications from your desktop
                  or mobile device to us, you are communicating with us
                  electronically. By sending, you agree to receive a reply to
                  communications from us electronically in the same format and
                  you can keep copies of these communications for your records.
                </p>
              </IonText>
              ...
              <IonText>
                <p>
                  {" "}
                  www.igurufy.com is an online website to provide quality
                  services tailored to the public need along with allowing
                  reviewers/users to rate/review on Gurus regarding past
                  experiences with them on either a personal or business
                  engagement. Under this website, the Gurus work as Seller in
                  order to sell their services online. The Customer/reviewer can
                  purchase the services of the Seller/Guru through this website
                  by subscribing various membership plan available on the
                  website/ via one time cost fee’s as well. This website also
                  provide the facility to the Customer to give reviews and
                  ratings about the services of the Guru/Seller through the
                  website on both current and past experiences encountered with
                  the Guru.
                </p>
              </IonText>
              ...
              <IonText>
                <p>
                  {" "}
                  If you access this website anonymously, you will not be
                  required to create a user name. But, in order to access
                  certain Resources, you may be required to provide specific
                  information and to create a user ID or sign up via your
                  Instagram username and password to establish an account.
                </p>
              </IonText>
              <IonText>
                <p>
                  You agree that the information you provide in connection with
                  establishing any account is accurate and that you will keep
                  your information up-to-date. You are responsible for the
                  ...
                  billing information), and you are solely responsible for any
                  use (authorized or not) of your accounts. You agree to notify
                  us immediately about any unauthorized activity regarding any
                  of your accounts or other breaches of security. We may at our
              ...
              <IonText>
                <p>
                  ...
                  specifically commissioned by us for publication on the
                  Websites.
                </p>
              </IonText>
              ...
              <IonText>
                <p>
                  ...
                  original source or the author(s) of that material and where
                  any content has been commissioned by us for publication on the
                  Websites, any proprietary rights in such content remain with
                  the relevant author, unless otherwise agreed or specified.
                </p>
              </IonText>
              ...
              <IonText>
                <p>
                  ...
                  in and to all content on the Websites; this includes all text,
              ...
              <IonText>
                <p>
                  ...
                  required permission to use the content. When posting content
                  to us, please do not post content that:
                </p>
              </IonText>
              <IonText>
                <p>
                  ...
                  or in bad taste, proactively attacks of a persona, religious
                  or racial nature.
                </p>
              </IonText>
              <IonText>
                <p>
                  is offensive, intimidating, disapproving, grossly
                  inflammatory, untrue, deceptive, fake, inaccurate, unfair,
                  contains gross overstatement or unproven claims
                </p>
              </IonText>

              <IonText>
                <p>
                  infringes the privacy rights of any third party is
                  unnecessarily damaging or unpleasant to any individual or
                  public
                </p>
              </IonText>
              <IonText>
                <p>
                  differentiates on the basis of race, religion, national
                  origin, sex, age, marital status, sexual orientation or
              ...
              <IonText>
                <p>
                  {" "}
                  infringes or unsuitably encourages the damage of any
              ...
              <IonText>
                <p>
                  {" "}
                  practices or try to use another’s account, password, service
                  or system except as specifically permitted by the Terms of use
                  uploads or transmits viruses or other destructive, disturbing
                  or disparaging files
                </p>
              </IonText>
              ...
              <IonText>
                <p>
                  ...
                  following, will be amended or rejected. If recurring
                  violations happen, we reserves the right to cancel user access
                  to website without advanced notice.
                </p>
              </IonText>
              ...
              <IonText>
                <p>
                  ...
                  described, your sole remedy is to intimate us about Services
              ...
              <IonText>
                <p>
                  ...
                  us with its details and warrant that these details are
                  accurate and complete at the time of ordering.
                </p>
              </IonText>

              <IonText>
                <p>
                  <strong>SUBSCRIPTION CHARGES:</strong> It is agreed by the
                  user that for becoming Customer:
                </p>
              </IonText>
              ...
              <IonText>
                <p>
                  Any order for subscription to Member plan that you place with
                  us is subject to acceptance by us. When you place your order
                  online we will send you an email to confirm that we have
                  received it. This email confirmation will be produced
                  automatically so that you have confirmation of your order and
              ...
              <IonText>
                <p>
                  <strong>Geographic Restriction</strong>
                </p>
              </IonText>
              ...
              <IonText>
                <p>
                  {" "}
                  We reserve the right, but not the obligation, to limit the
                  usage or supply of any service to any person, geographic
                  region or jurisdiction. We may use this right as per the
                  necessity. We reserve the right to suspend any Service at any
                  time. Any offer to provide any Service made on this Website is
              ...
              <IonText>
                <p>
                  {" "}
                  You shall not use any virus, hacking tool for interfering in
                  the operation of the website or data and files of the website;
                </p>
              </IonText>
              <IonText>
                <p>
              ...
              <IonText>
                <p>
                  {" "}
                  <strong>Representation And Wrranties</strong>
                </p>
              </IonText>
              <IonText>
                <p>
              ...
              <IonText>
                <p>
                  ...
                  misleading or likely to deceive or mislead or that is
                  defamatory or indecent or which otherwise offends the ethical
                  and moral standards of society. Further, the Service does not
                  infringes a copyright, trademark or otherwise infringes any
                  intellectual property rights; that breaches any provision of
                  any statute, regulation, bye law or any other rule or law, as
                  may be applicable in force from time to time;
                </p>
              </IonText>
              ...
              <IonText>
                <p>
                  ...
                  proceeds, figures, usage, goodwill, or other intangible
                  losses, consequential from (i) your use or access of or
                  failure to access or use the Service; (ii) any conduct or
                  content of any third party on the Service; (iii) any content
                  attained from the Service; and (iv) unlawful access, use or
                  alteration of your transmissions or content, whether or not
                  based on guarantee, agreement, domestic wrong (including
                  carelessness) or any other lawful concept, whether or not
                  we’ve been aware of the possibility of such damage, and even
                  if a cure set forth herein is originate to have futile of its
                  important purpose.
                </p>
              </IonText>
              <IonText>
                <p>
                  {" "}
                  <strong>Modifications To The Service Price</strong>
                </p>
              </IonText>
              <IonText>
                <p>
                  {" "}
                  We reserve the right, in its discretion, to change, modify,
                  add to, or remove portions of the Terms (collectively,
                  “Changes”), at any time. We may notify you of Changes by
                  sending an email to the address identified in your Account or
                  by posting a revised version of the Terms incorporating the
                  Changes to its Website. Your unrelenting use of the Website or
                  Services ensuing notice of the Modifications (or posting of
                  the Terms incorporating the Modifications in the event your
                  email address is no longer lawful, is obstructed, or is
                  otherwise not able to obtain the notice) will mean that you
                  agree to the Changes. Such Modifications will apply
                  prospectively beginning on the date, the Changes are posted to
                  the Website.We reserve the right, in its discretion, to
                  change, modify, add to, or remove portions of the Terms
                  (collectively, “Changes”), at any time. We may notify you of
                  Changes by sending an email to the address identified in your
                  Account or by posting a revised version of the Terms
                  ...
                  (or posting of the Terms incorporating the Modifications in
                  the event your email address is no longer lawful, is
                  obstructed, or is otherwise not able to obtain the notice)
                  will mean that you agree to the Changes. Such Modifications
                  will apply prospectively beginning on the date, the Changes
                  are posted to the Website.We reserve the right, in its
                  discretion, to change, modify, add to, or remove portions of
                  the Terms (collectively, “Changes”), at any time. We may
                  notify you of Changes by sending an email to the address
                  identified in your Account or by posting a revised version of
                  the Terms incorporating the Changes to its Website. Your
                  unrelenting use of the Website or Services ensuing notice of
                  the Modifications (or posting of the Terms incorporating the
              ...
              <IonText>
                <p>
                  ...
                  exclusively as ease to you and not as an authorization by us
                  of the content on such External Sites. The content of such
                  External Sites is created and used by others. You can
                  communicate the site administrator for those External Sites.
                  We are not accountable for the content provided in the link of
                  any External Sites and do not provide any representations
                  about the content or correctness of the information on such
                  External Sites. You should take safety measure when you are
                  downloading files from all these websites to safeguards your
                  computer from viruses and other critical programs. If you
                  agree to access linked External Sites, you do so at your own
                  risk.
                </p>
              </IonText>
              <IonText>
                <p>
                  {" "}
                  <strong>Personal Information and Privacy police</strong>
                </p>
              </IonText>
              <IonText>
                <p>
                  {" "}
                  By accessing or using this Website, you approve us to use,
                  store or otherwise process your personal information as per
                  our Privacy Policy.Errors, Inaccuracies And Omissions
                </p>
              </IonText>
              <IonText>
                <p>
              ...
              <IonText>
                <p>
                  ...
                  offered on this Website is accurate and error-free. We
                  apologize for any errors or omissions that may have occurred.
                  We cannot warrant that use of the Website will be error-free
                  or fit for purpose, timely, that defects will be corrected, or
                  that the site or the server that makes it available are free
                  of viruses or bugs or represents the full functionality,
                  accuracy, reliability of the Website and we do not make any
              ...
              <IonText>
                <p>
                  ...
                  PERFORMANCE, OR USAGE OF TRADE. IN CONNECTION WITH ANY
                  WARRANTY, CONTRACT, OR COMMON LAW TORT CLAIMS: (I) WE SHALL
                  NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL, OR CONSEQUENTIAL
                  DAMAGES, LOST PROFITS, OR DAMAGES RESULTING FROM LOST DATA OR
                  BUSINESS INTERRUPTION RESULTING FROM THE USE OR INABILITY TO
                  ACCESS AND USE THE WEBSITE OR THE CONTENT, EVEN IF WE HAVE
                  BEEN ADVISED OF THE POSSIBILITY OF SUCH DAMAGES; AND (II) ANY
                  DIRECT DAMAGES THAT YOU MAY SUFFER AS A RESULT OF YOUR USE OF
                  THE WEBSITE OR THE CONTENT SHALL BE LIMITED TO THE MONIES YOU
                  HAVE PAID US IN CONNECTION WITH YOUR USE OF THE WEBSITE DURING
                  THE THREE (3) MONTHS IMMEDIATELY PRECEDING THE EVENTS GIVING
                  RISE TO THE CLAIM. THE WEBSITE MAY CONTAIN TECHNICAL
                  INACCURACIES OR TYPOGRAPHICAL ERRORS OR OMISSIONS. UNLESS
                  REQUIRED BY APPLICABLE LAWS, WE ARE NOT RESPONSIBLE FOR ANY
                  SUCH TYPOGRAPHICAL, TECHNICAL, OR PRICING ERRORS LISTED ON THE
                  WEBSITE. THE WEBSITE MAY CONTAIN INFORMATION ON CERTAIN
                  SERVICES, NOT ALL OF WHICH ARE AVAILABLE IN EVERY LOCATION. A
                  REFERENCE TO A SERVICE ON THE WEBSITES DOES NOT IMPLY THAT
                  SUCH SERVICE IS OR WILL BE AVAILABLE IN YOUR LOCATION. WE
              ...
              <IonText>
                <p>
                  The Website contains material, such as software, text,
                  graphics, images, designs, sound recordings, audiovisual
                  works, and other the material provided by or on behalf of us
                  (collectively referred to as the “Content”). The Content may
                  be owned by us or third parties. Unauthorized use of the
                  Content may violate copyright, trademark, and other laws. You
                  have no rights in or to the Content, and you will not use the
                  Content except as permitted under this Agreement. No other use
                  is permitted without prior written consent from us. You must
                  ...
                  use or posting of the Content on any other website or in a
              ...
              <IonText>
                <p>
                  ...
                  located on the website may be trademarks or service marks
                  owned by others (the “Third-Party Trademarks,” and,
                  collectively with us, the “Trademarks”). Nothing on the
                  website should be construed as granting, by implication,
                  estoppel, or otherwise, any license or right to use the
                  Trademarks, without our prior written permission specific for
                  each such use. None of the Content may be retransmitted
                  without our express, written consent for each and every
                  instance.
                </p>
              </IonText>
              ...
              <IonText>
                <p>
                  ...
                  fees, arising or resulting from your breach of this Agreement
                  or your misuse of the Content or the Website. We shall provide
                  notice to you of any such claim, suit, or proceeding and shall
                  assist you, at your expense, in defending any such claim,
                  suit, or proceeding. We reserve the right, at your expense, to
                  assume the exclusive defense and control of any matter that is
                  subject to indemnification under this section. In such case,
              ...
              <IonText>
                <p>
                  ...
                  at any time, with or without cause, upon written notice. We
                  will have no liability to you or any third party because of
                  such termination. Termination of these Terms will terminate
                  all of your Services subscriptions. Effect of Termination.
                  Upon termination of these Terms for any reason, or
                  cancellation or expiration of your Services: (a) We will cease
                  providing the Services; (b) you will not be entitled to any
                  refunds or usage fees, or any other fees, pro-rata or
                  otherwise; (c) any fees you owe to us will immediately become
                  due and payable in full, and (d) we may delete your archived
                  data within 30 days. All sections of the Terms that expressly
                  provide for survival, or by their nature should survive, will
                  survive termination of the Terms, including, without
                  limitation, indemnification, warranty disclaimers, and
              ...
              <IonText>
                <p>
                  ...
                  to the subject matter of these Terms, and any modifications
                  must be in a writing signed by both parties, except as
                  otherwise provided herein. GOVERNING LAW AND JUDICIAL
                  RECOURSE:The terms herein will be governed by and construed in
                  accordance with the laws of the United States of America and
                  laws of the State of California without giving effect to any
                  principles or conflicts of law. The courts of the State of
              ...
              <IonText>
                <p>
                  {" "}
                  FORCE MAJEURE: We will have no liability to you, your users,
                  or any third party for any failure us to perform its
                  obligations under these Terms in the event that such
                  non-performance arises as a result of the occurrence of an
                  event beyond the reasonable control of us, including, without
                  limitation, an act of war or terrorism, natural disaster,
                  failure of electricity supply, riot, civil disorder, or civil
              ...
              <IonText>
                <p>
                  ...
                  the Services incorporated within the Services and without
                  which the Services could not be provided to you.
                </p>
              </IonText>
              <IonText>
                <p>
                  {" "}
                  ASSIGNMENT: The Company shall have the right to
                  assign/transfer these presents to any third party including
                  its holding company, subsidiaries, affiliates, associates and
              ...
              <IonText>
                <p>
                  ...
                  Terms, please contact us at info@igurufy.com
                </p>
              </IonText>
              <br />
            </div>
