...
var reWireGetterSetter = (instance, hostRef) => {
  ...
  members.map(([memberName, [memberFlags]]) => {
    if (BUILD.state && BUILD.prop && (memberFlags & 2048) === 0 && (memberFlags & 31 || memberFlags & 32)) {
...
var updateFallbackSlotVisibility = (elm) => {
  ...
  for (const childNode of childNodes) {
    if (childNode.nodeType === 1 && (childNode.__childNodes || childNode.childNodes).length) {
...
var getHostSlotChildNodes = (node, slotName, includeSlot = true) => {
  const childNodes = [];
  if (includeSlot && node["s-sr"] || !node["s-sr"])
...
var patchChildSlotNodes = (elm) => {
  ...
  Object.defineProperty(elm, "childNodes", {
    get() {
      var _a, _b;
      if (!plt.$flags$ || !((_a = getHostRef(this)) == null ? void 0 : _a.$flags$) || (plt.$flags$ & 1) === 0 && ((_b = getHostRef(this)) == null ? void 0 : _b.$flags$) & 2) {
...
var patchNextPrev = (node) => {
  if (!node || node.__nextSibling || !globalThis.Node)
    return;
...
var initializeClientHydrate = (hostElm, tagName, hostId, hostRef) => {
  ...
  if (BUILD.shadowDom && shadowRoot) {
    ...
    Array.from(hostElm.childNodes).forEach((node) => {
      if (node.nodeType === 8 && typeof node["s-sn"] !== "string") {
...
More information: https://stenciljs.com/docs/properties#prop-mutability`
        ...
        } else if (flags & 1 && memberFlags & 2048) {
          if (BUILD.lazyLoad) {
            Object.defineProperty(prototype, memberName, {
              get() {
                const ref = getHostRef(this);
    ...
    if (BUILD.style && Cstr && Cstr.style) {
      ...
      if (!styles.has(scopeId2)) {
        ...
        BUILD.shadowDomShim && cmpMeta.$flags$ & 8) {
          style = await import("./shadow-css-UCQAATIM.js").then((m) => m.scopeCss(style, scopeId2));
        }
...
*/
//# sourceMappingURL=chunk-UEK7ZA6G.js.map
